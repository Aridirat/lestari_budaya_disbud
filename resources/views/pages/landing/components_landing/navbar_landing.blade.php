            ...
            <div class="grow">
              <div class="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
                ...
                <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:[--adaptive:adaptive] [--is-collapse:true] md:[--is-collapse:false] ">
                  <button id="hs-header-base-mega-menu-small" type="button" class="hs-dropdown-toggle w-full p-2 flex items-center text-sm text-gray-800 rounded-lg focus:outline-hidden focus:bg-teal-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-teal-700 {{ request()->is('create_odcb') || request()->is('create_opk') ? 'bg-teal-200 text-gray-800' : '' }}" aria-haspopup="menu" aria-expanded="false" aria-label="Mega Menu">
