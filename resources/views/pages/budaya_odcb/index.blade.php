...
<div class="modal fade" id="modalDetail{{ $item->id }}" tabindex="-1" aria-labelledby="modalDetailLabel{{ $item->id }}" aria-hidden="true">
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="modalDetailLabel{{ $item->id }}">Detail ODCB</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <p><strong>Nama Obyek:</strong> {{ $item->nama_obyek }}</p>
            <p><strong>Deskripsi:</strong> {{ $item->deskripsi }}</p>
            <p><strong>Kategori:</strong> {{ $item->kategori }}</p>
            <p><strong>Lokasi Penemuan:</strong> {{ $item->lokasi_penemuan }}</p>
            <p><strong>Nama Pemilik:</strong> {{ $item->nama_pemilik }}</p>
            <p><strong>Alamat:</strong> {{ $item->alamat_pemilik }}</p>
            <p><strong>Status:</strong> {{ $item->status_pemilik }}</p>
