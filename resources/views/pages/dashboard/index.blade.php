    ...
    <div class="flex flex-wrap mt-6 -mx-3">
      ...
      <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
        <div slider class="relative w-full h-full overflow-hidden rounded-2xl">
          ...
          <!-- Control buttons -->
          <button btn-next class="absolute z-10 w-10 h-10 p-2 text-lg text-white border-none opacity-50 cursor-pointer hover:opacity-100 far  active:scale-110 top-6 right-4"></button>
          <button btn-prev class="absolute z-10 w-10 h-10 p-2 text-lg text-white border-none opacity-50 cursor-pointer hover:opacity-100 far  active:scale-110 top-6 right-16"></button>
        </div>
      </div>
    </div>
