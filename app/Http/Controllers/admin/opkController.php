...
class OpkController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'alamat_narasumber' => 'required|in:Badung,Bangli,Buleleng,Gianyar,Jembrana,Karangasem,Klungkung,Tabanan,Denpasar',
    ...
    public function update(Request $request, $id)
    {
        $validated = $request->validate([
            ...
            'deskripsi' => 'required|string',
            'alamat_tradisi' => 'required|string',
            'lokasi_tradisi' => 'required|in:Badung,Bangli,Buleleng,Gianyar,Jembrana,Karangasem,Klungkung,Tabanan,Denpasar',
            'nama_narasumber' => 'required|string|max:255',
            'alamat_narasumber' => 'required|in:Badung,Bangli,Buleleng,Gianyar,Jembrana,Karangasem,Klungkung,Tabanan,Denpasar',
            'no_hp' => 'required|string|max:15',
            'kode_pos' => 'required|string|max:10',
